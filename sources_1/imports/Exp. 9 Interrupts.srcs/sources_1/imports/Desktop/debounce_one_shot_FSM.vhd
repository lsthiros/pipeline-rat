...
architecture Behavioral of db_1shot_FSM is
   ...
   constant c_LOW_GOING_HIGH_CLOCKS : std_logic_vector := x"19"; -- was x"19" -> 25 clks
   constant c_HIGH_GOING_LOW_CLOCKS : std_logic_vector := x"33"; -- was x"33" -> 50 clks
   constant c_ONE_SHOT_CLOCKS       : std_logic_vector := x"02"; -- 3 clks
